...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        # Инициализация весов и смещений для сверточного слоя
        self.params['W1'] = weight_scale * np.random.randn(num_filters, input_dim[0], filter_size, filter_size)
        self.params['b1'] = np.zeros(num_filters)
        
        # Размеры после пулинг слоя
        pool_output_dim = num_filters * (input_dim[1] // 2) * (input_dim[2] // 2)

        # Инициализация весов и смещений для скрытого слоя
    ...
    def loss(self, X, y=None):
        ...
        # Параметры для сверточного слоя
        filter_size = W1.shape[2]
        conv_param = {'stride': 1, 'pad': (filter_size - 1) // 2}
        
        # Параметры для пулинг слоя
        pool_param = {'pool_height': 2, 'pool_width': 2, 'stride': 2}
        
        # Прямой проход
        # Вы можете использовать функции conv_forward_naive и max_pool_forward_naive из предыдущих задач,
        # или прямые реализации из cs231n/fast_layers.py
